...
export function Timeline() {
    ...
    return (
        <section className="py-8 sm:py-12 w-full select-none bg-gray-50/50 rounded-3xl p-6 sm:p-8 border border-gray-100">
                            ...
                            <React.Fragment key={stepData.step}>
                                ...
                                >
                                    ...
                                    <div className="relative mb-4">
                                        <div className="h-16 w-16 rounded-full bg-white border-2 border-gray-100 flex items-center justify-center text-[#5B3DF5] shadow-sm group-hover:border-[#5B3DF5]/30 group-hover:shadow-md transition-all">
                                            <IconComponent className="h-6 w-6 stroke-[1.8]" />
                                        </div>
                                        {/* Circle Number */}
                                        <span className="absolute -top-1.5 -right-1.5 h-6 w-6 rounded-full bg-[#5B3DF5] text-white text-xs font-black flex items-center justify-center border-2 border-white">
                                            {stepData.step}
                                        </span>
                                    </div>

                                    <h3 className="font-extrabold text-sm text-gray-900 mb-1.5 leading-tight group-hover:text-[#5B3DF5] transition-colors">
                                        {stepData.title}
                                    </h3>
