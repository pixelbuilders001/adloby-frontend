    ...
    return (
        <div className="space-y-8">
            <div className="flex flex-col gap-2">
                <h2 className="text-3xl font-black text-slate-900 tracking-tight">Select Media Type</h2>
                    ...
                    {MEDIA_TYPES.map((type) => {
                        ...
                        return (
                            <button
                                ...
                                className={cn(
                                    "relative flex flex-col items-center justify-center gap-4 p-8 rounded-3xl border-2 transition-all duration-300 group active:scale-[0.98]",
                                    isSelected
                            ...
                            >
                                ...
                                <span className={cn(
                                    "font-black tracking-tight text-center leading-tight",
            ...
            <div className="fixed bottom-0 left-0 right-0 p-4 bg-white/80 backdrop-blur-md border-t border-gray-100 lg:static lg:bg-transparent lg:border-0 lg:p-0 z-40">
                <div className="max-w-7xl mx-auto flex items-center justify-between gap-6 font-bold lg:pt-8 bg-white lg:bg-transparent p-4 lg:p-0 rounded-t-[32px] lg:rounded-none shadow-2xl lg:shadow-none">
                    ...
                    <div className="flex flex-col lg:hidden flex-1 pl-4">
                        <span className="text-[10px] text-gray-400 uppercase tracking-widest leading-none mb-1">Starting From</span>
                        <span className="text-xl font-black text-[#5B3DF5]">₹1,800</span>
                    </div>
